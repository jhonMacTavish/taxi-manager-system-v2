                    ...
                    <el-col :span="12">
                        ...
                        <div class="terminal border-root-line">
                            <div class="terminal_line">
                                ...
                                <div class="add-number" @click="loadTableData('t1_terminal_1_with1h')">
                                    {{terminal_1_1_with1h}}</div>
                            </div>
                            <div class="terminal_line">
                                <div class="line border-line">第二条道</div>
                                <div class="number" @click="loadTableData('t1_terminal_2')">{{terminal_2_1 }}</div>
                                <div class="add-number" @click="loadTableData('t1_terminal_2_with1h')">
                                    {{terminal_2_1_with1h}}</div>
                            </div>
                            <div class="terminal_line">
                                <div class="line border-line">补短通道</div>
                                <div class="number" @click="loadTableData('t1_terminal_pd1')">{{terminal_short_1 }}
                                </div>
                                <div class="add-number" @click="loadTableData('t1_terminal_pd1_with1h')">
                                    {{terminal_short_1_with1h}}</div>
                            </div>
                        </div>
                    </el-col>
                </el-row>
                    ...
                    <el-col :span="12">
                        ...
                        <div class="terminal border-root-line">
                            <div class="terminal_line">
                                ...
                                <div class="add-number" @click="loadTableData('t2_terminal_1_with1h')">
                                    {{terminal_1_2_with1h}}</div>
                            </div>
                            <div class="terminal_line">
                                <div class="line border-line">第二条道</div>
                                <div class="number" @click="loadTableData('t2_terminal_2')">{{terminal_2_2 }}</div>
                                <div class="add-number" @click="loadTableData('t2_terminal_2_with1h')">
                                    {{terminal_2_2_with1h}}</div>
                            </div>
                            <div class="terminal_line">
                                <div class="line border-line">补短通道</div>
                                <div class="number" @click="loadTableData('t2_terminal_3')">{{terminal_short_2 }}</div>
                                <div class="add-number" @click="loadTableData('t2_terminal_pd1_with1h')">
                                    {{terminal_short_2_with1h}}</div>
                            </div>
                        </div>
                    </el-col>
                </el-row>
